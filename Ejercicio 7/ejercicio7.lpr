...
begin
     // Incisos a y b
        ...
        // Resultados
           ...
           writeLn('Carta figura del mazo rojo, cualquier palo: ',(numero1=10) or (numero1=11) or (numero1=12));
     ...
     // Resto de los incisos
        ...
        // Resultados
           writeLn('Dos cartas iguales de diferente mazo: ',(palo1=palo2) and (color1=color2));
           writeLn('Dos cartas consecutivas del mismo palo sin importar el mazo: ',(abs(numero1-numero2)=1) and (palo1=palo2));
           writeLn('Dos cartas suman doce, de distinto palo y mazo: ',(numero1+numero2=12) and (palo1<>palo2) and (color1<>color2));
           writeLn('Dos cartas de igual número, en el mismo mazo o del mismo palo: ',(numero1=numero2) and ((color1=color2) or (palo1=palo2)));
           writeLn('Dos cartas de distinto número en el mismo mazo y palo: ',(numero1<>numero2) and (color1=color2) and (palo1=palo2));
           ...
           // cuando coinciden en el mazo, el palo determina supremacía en el orden en que se describieron
                    // Combinaciones en las que el palo1='O'
                       (palo1='O') and (palo2='C') or (palo1='O') and (palo2='E') or (palo1='O') and (palo2='B') or
